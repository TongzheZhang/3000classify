function [Weights,Bias,SVs,Weights_sizepre,Bias_sizepre,svm_used,iteration]=RankSVM_train(train_data,train_target,svm,cost,lambda_tol,norm_tol,max_iter)
...
if(strcmp(svm,'RBF'))%以前是svm.type
    ...
    if(strcmp(svm,'Poly'))%以前是svm.type
        for i=1:num_training
            for j=1:num_training
                gamma=svm.para(1);
